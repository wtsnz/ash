...
defmodule Ash.Conformance.IsolationResources do
...
defmodule Ash.Conformance.SqliteIsolationResources do
  @moduledoc false
  use Ash.Conformance.IsolationResources, namespace: Ash.Conformance.Sqlite, adapter: :sqlite
end
