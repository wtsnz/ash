  ...
  defmacro __using__(opts) do
    ...
    quote context: Elixir do
      defmodule unquote(parent) do
        use Ash.Conformance.Resources.Base, adapter: unquote(adapter), table: "ac_parents"
      ...
      defmodule unquote(child) do
        use Ash.Conformance.Resources.Base, adapter: unquote(adapter), table: "ac_children"
        ...
        actions do
          ...
          read :from_context do
            prepare({Ash.Conformance.Resources.Scope, from: :context})
          end

          read :for_actor do
            prepare({Ash.Conformance.Resources.Scope, from: :actor})
          end

          read :for_tenant do
            prepare({Ash.Conformance.Resources.Scope, from: :tenant, field: :tenant_id})
          end
        end
      ...
      defmodule unquote(rating) do
        use Ash.Conformance.Resources.Base, adapter: unquote(adapter), table: "ac_ratings"
      ...
      defmodule unquote(tag) do
        use Ash.Conformance.Resources.Base, adapter: unquote(adapter), table: "ac_tags"
      ...
      defmodule unquote(link) do
        use Ash.Conformance.Resources.Base, adapter: unquote(adapter), table: "ac_links"
      ...
      defmodule unquote(child_tag) do
        use Ash.Conformance.Resources.Base, adapter: unquote(adapter), table: "ac_child_tags"
      ...
      defmodule unquote(event) do
        use Ash.Conformance.Resources.Base, adapter: unquote(adapter), table: "ac_events"
      ...
      defmodule unquote(reading) do
        use Ash.Conformance.Resources.Base, adapter: unquote(adapter), table: "ac_readings"
