...
defmodule Ash.Conformance.SqliteResources do
  @moduledoc false
  use Ash.Conformance.Resources, namespace: Ash.Conformance.Sqlite, adapter: :sqlite
end

defmodule Ash.Conformance.PostgresResources do
  @moduledoc false
  use Ash.Conformance.Resources, namespace: Ash.Conformance.Postgres, adapter: :postgres
end
