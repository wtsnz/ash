...
defmodule Ash.Conformance.Scenarios.Aggregates.Types do
  ...
  #
  # Each group requires its read control: the readings read back exactly.
  # The controls require the storage cells of the values they hold.
  @decimals [requires: ["values.decimal_read_control"]]
  @temporal [requires: ["values.temporal_read_control"]]
  ...
  defp temporal do
    [
      new(
        "values.temporal_read_control",
        :results,
        %{
          301 => {~D[2024-01-09], ~U[2024-01-01 09:59:59.999999Z], ~T[09:30:00]},
          302 => {~D[2024-01-10], ~U[2024-01-01 10:00:00.000000Z], ~T[10:15:00]},
          303 => {~D[2023-12-31], ~U[2023-12-31 23:59:59.000001Z], ~T[23:59:59]},
          304 => {~D[2024-02-01], ~U[2024-02-01 00:00:00.000000Z], ~T[00:00:00]}
        },
        fn ctx ->
          ctx.adapter.resource(:reading)
          |> Ash.read!(authorize?: false)
